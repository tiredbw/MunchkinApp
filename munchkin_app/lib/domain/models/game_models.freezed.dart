...
mixin _$Player {
 ...
 String get id; String get name; bool get isHost; int get level; int get peakLevel; int get strength; List<MunchkinRace> get races; List<MunchkinClass> get classes; bool get isConnected; bool get isLocal; String? get localControllerPlayerId; DateTime? get lastSeenAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,isHost,level,peakLevel,strength,const DeepCollectionEquality().hash(races),const DeepCollectionEquality().hash(classes),isConnected,isLocal,localControllerPlayerId,lastSeenAt);

@override
String toString() {
  return 'Player(id: $id, name: $name, isHost: $isHost, level: $level, peakLevel: $peakLevel, strength: $strength, races: $races, classes: $classes, isConnected: $isConnected, isLocal: $isLocal, localControllerPlayerId: $localControllerPlayerId, lastSeenAt: $lastSeenAt)';
}
...
@useResult
$Res call({
 String id, String name, bool isHost, int level, int peakLevel, int strength, List<MunchkinRace> races, List<MunchkinClass> classes, bool isConnected, bool isLocal, String? localControllerPlayerId, DateTime? lastSeenAt
});
...
/// Create a copy of Player
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? isHost = null,Object? level = null,Object? peakLevel = null,Object? strength = null,Object? races = null,Object? classes = null,Object? isConnected = null,Object? isLocal = null,Object? localControllerPlayerId = freezed,Object? lastSeenAt = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  bool isHost,  int level,  int peakLevel,  int strength,  List<MunchkinRace> races,  List<MunchkinClass> classes,  bool isConnected,  bool isLocal,  String? localControllerPlayerId,  DateTime? lastSeenAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Player() when $default != null:
return $default(_that.id,_that.name,_that.isHost,_that.level,_that.peakLevel,_that.strength,_that.races,_that.classes,_that.isConnected,_that.isLocal,_that.localControllerPlayerId,_that.lastSeenAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  bool isHost,  int level,  int peakLevel,  int strength,  List<MunchkinRace> races,  List<MunchkinClass> classes,  bool isConnected,  bool isLocal,  String? localControllerPlayerId,  DateTime? lastSeenAt)  $default,) {final _that = this;
switch (_that) {
case _Player():
return $default(_that.id,_that.name,_that.isHost,_that.level,_that.peakLevel,_that.strength,_that.races,_that.classes,_that.isConnected,_that.isLocal,_that.localControllerPlayerId,_that.lastSeenAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  bool isHost,  int level,  int peakLevel,  int strength,  List<MunchkinRace> races,  List<MunchkinClass> classes,  bool isConnected,  bool isLocal,  String? localControllerPlayerId,  DateTime? lastSeenAt)?  $default,) {final _that = this;
switch (_that) {
case _Player() when $default != null:
return $default(_that.id,_that.name,_that.isHost,_that.level,_that.peakLevel,_that.strength,_that.races,_that.classes,_that.isConnected,_that.isLocal,_that.localControllerPlayerId,_that.lastSeenAt);case _:
  return null;
...
class _Player extends Player {
  const _Player({required this.id, required this.name, required this.isHost, required this.level, this.peakLevel = 1, required this.strength, final  List<MunchkinRace> races = const <MunchkinRace>[MunchkinRace.human], final  List<MunchkinClass> classes = const <MunchkinClass>[], this.isConnected = true, this.isLocal = false, this.localControllerPlayerId, this.lastSeenAt}): _races = races,_classes = classes,super._();
...
@override@JsonKey() final  int peakLevel;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,isHost,level,peakLevel,strength,const DeepCollectionEquality().hash(_races),const DeepCollectionEquality().hash(_classes),isConnected,isLocal,localControllerPlayerId,lastSeenAt);
...
/// Create a copy of Player
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? isHost = null,Object? level = null,Object? peakLevel = null,Object? strength = null,Object? races = null,Object? classes = null,Object? isConnected = null,Object? isLocal = null,Object? localControllerPlayerId = freezed,Object? lastSeenAt = freezed,}) {
...
mixin _$GameState {
 ...
 int get schemaVersion; String get roomId; int get revision; RoomSettings get settings; RoomPhase get phase; List<Player> get players; List<String> get turnOrder; String? get activePlayerId; bool get battleFoughtThisTurn; BattleState? get battle; DiceRoll? get lastDiceRoll; DateTime? get startedAt; DateTime? get endedAt; DateTime get createdAt; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,schemaVersion,roomId,revision,settings,phase,const DeepCollectionEquality().hash(players),const DeepCollectionEquality().hash(turnOrder),activePlayerId,battleFoughtThisTurn,battle,lastDiceRoll,startedAt,endedAt,createdAt,updatedAt);

@override
String toString() {
  return 'GameState(schemaVersion: $schemaVersion, roomId: $roomId, revision: $revision, settings: $settings, phase: $phase, players: $players, turnOrder: $turnOrder, activePlayerId: $activePlayerId, battleFoughtThisTurn: $battleFoughtThisTurn, battle: $battle, lastDiceRoll: $lastDiceRoll, startedAt: $startedAt, endedAt: $endedAt, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int schemaVersion, String roomId, int revision, RoomSettings settings, RoomPhase phase, List<Player> players, List<String> turnOrder, String? activePlayerId, bool battleFoughtThisTurn, BattleState? battle, DiceRoll? lastDiceRoll, DateTime? startedAt, DateTime? endedAt, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of GameState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? schemaVersion = null,Object? roomId = null,Object? revision = null,Object? settings = null,Object? phase = null,Object? players = null,Object? turnOrder = null,Object? activePlayerId = freezed,Object? battleFoughtThisTurn = null,Object? battle = freezed,Object? lastDiceRoll = freezed,Object? startedAt = freezed,Object? endedAt = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_self.copyWith(
...
as DiceRoll?,startedAt: freezed == startedAt ? _self.startedAt : startedAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int schemaVersion,  String roomId,  int revision,  RoomSettings settings,  RoomPhase phase,  List<Player> players,  List<String> turnOrder,  String? activePlayerId,  bool battleFoughtThisTurn,  BattleState? battle,  DiceRoll? lastDiceRoll,  DateTime? startedAt,  DateTime? endedAt,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameState() when $default != null:
return $default(_that.schemaVersion,_that.roomId,_that.revision,_that.settings,_that.phase,_that.players,_that.turnOrder,_that.activePlayerId,_that.battleFoughtThisTurn,_that.battle,_that.lastDiceRoll,_that.startedAt,_that.endedAt,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int schemaVersion,  String roomId,  int revision,  RoomSettings settings,  RoomPhase phase,  List<Player> players,  List<String> turnOrder,  String? activePlayerId,  bool battleFoughtThisTurn,  BattleState? battle,  DiceRoll? lastDiceRoll,  DateTime? startedAt,  DateTime? endedAt,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _GameState():
return $default(_that.schemaVersion,_that.roomId,_that.revision,_that.settings,_that.phase,_that.players,_that.turnOrder,_that.activePlayerId,_that.battleFoughtThisTurn,_that.battle,_that.lastDiceRoll,_that.startedAt,_that.endedAt,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int schemaVersion,  String roomId,  int revision,  RoomSettings settings,  RoomPhase phase,  List<Player> players,  List<String> turnOrder,  String? activePlayerId,  bool battleFoughtThisTurn,  BattleState? battle,  DiceRoll? lastDiceRoll,  DateTime? startedAt,  DateTime? endedAt,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _GameState() when $default != null:
return $default(_that.schemaVersion,_that.roomId,_that.revision,_that.settings,_that.phase,_that.players,_that.turnOrder,_that.activePlayerId,_that.battleFoughtThisTurn,_that.battle,_that.lastDiceRoll,_that.startedAt,_that.endedAt,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _GameState extends GameState {
  const _GameState({this.schemaVersion = 1, required this.roomId, this.revision = 0, required this.settings, this.phase = RoomPhase.lobby, final  List<Player> players = const <Player>[], final  List<String> turnOrder = const <String>[], this.activePlayerId, this.battleFoughtThisTurn = false, this.battle, this.lastDiceRoll, this.startedAt, this.endedAt, required this.createdAt, required this.updatedAt}): _players = players,_turnOrder = turnOrder,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,schemaVersion,roomId,revision,settings,phase,const DeepCollectionEquality().hash(_players),const DeepCollectionEquality().hash(_turnOrder),activePlayerId,battleFoughtThisTurn,battle,lastDiceRoll,startedAt,endedAt,createdAt,updatedAt);
